...
class StorePointdeventeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'pointdevente' => 'required|string|min:5|regex:/(^([a-zA-z ]+)(\d+)?$)/u|unique:pointdevente,pointdevente',
    ...
    public function messages()
    {
        return [
            ...
            'description.min' => "La description du point de vente ne pas avoir moins de 5 caracteres.",
        ];
    }
}
