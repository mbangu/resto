    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Ajout | Point de vente</h5>
            ...
            <div class="modal-body">
                <form class="" method="post">
                    ...
                    <button type="submit" class="btn btn-primary m-t-15 waves-effect add-btn">Ajouter point de vente</button>
                </form>
            </div>
        </div>
    </div>
...
<div class="modal fade " id="bd-update-modal-lg" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Modifier | Point de vente</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
